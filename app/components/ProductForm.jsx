...
export function ProductForm({ productOptions, selectedVariant }) {
  ...
  return (
    <div>
        ...
        <div style={{ marginBottom: '16px' }}>
          <div style={{ display: 'flex', gap: '8px', alignItems: 'stretch', width: '100%', boxSizing: 'border-box', maxWidth: '100vw', paddingRight: '16px' }}>
            ...
            <button type="button" onClick={() => setSizeGuideOpen(true)}
              className='size-guide-btn' style={{ height: '48px', padding: '0 8px', border: '1px solid #ccc', borderRadius: '6px', backgroundColor: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '3px', fontSize: '10px', fontWeight: '700', color: '#333', whiteSpace: 'nowrap', flexShrink: 0 }}>
              📐 SIZE GUIDE
            </button>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', gap: '6px', marginTop: '24px', alignItems: 'stretch', width: '100%', boxSizing: 'border-box', minWidth: 0 }}>
